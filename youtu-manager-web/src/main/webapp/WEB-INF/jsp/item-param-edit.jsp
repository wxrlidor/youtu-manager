...
<table cellpadding="5" style="margin-left: 30px" id="itemParamAddTable" class="itemParam">
	<tr>
		<td>商品类目:</td>
		<td><span id="catname"></span>
			<input type="hidden" name="cid" id="cid" style="width: 280px;"></input>
			<input type="hidden" name="id"  id="id" style="width: 280px;"></input>
		</td>
	</tr>
...
<script style="text/javascript">
	$(function(){
		...
		$("#itemParamAddTable .submit").click(function(){
			...
			var url = "/item/param/update/"+$("#itemParamAddTable [name=id]").val()+"/"+$("#itemParamAddTable [name=cid]").val();
